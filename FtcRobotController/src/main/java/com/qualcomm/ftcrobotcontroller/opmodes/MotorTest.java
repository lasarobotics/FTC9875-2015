...
public class MotorTest extends OpMode {
    DcMotor left_back_motor, left_front_motor, right_back_motor, right_front_motor, brush_motor;
    // Servo lever_servo;
    ...
    public void init() {
        ...
        // lever_servo = hardwareMap.servo.get("ls");
    ...
    public void loop() {
        ...
        /*if(gamepad1.left_trigger > trigger_threshold) {
            lever_servo.setPosition(lever_servo.getPosition() + dt * (servo_rv / 360));
